...
${OBJECTDIR}/C_Files/Cliente.o: C_Files/Cliente.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/C_Files/Cliente.o C_Files/Cliente.c
...
${OBJECTDIR}/C_Files/Habitacion.o: C_Files/Habitacion.c
	${MKDIR} -p ${OBJECTDIR}/C_Files
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/C_Files/Habitacion.o C_Files/Habitacion.c

${OBJECTDIR}/C_Files/Hotel.o: C_Files/Hotel.c
	${MKDIR} -p ${OBJECTDIR}/C_Files
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/C_Files/Hotel.o C_Files/Hotel.c

${OBJECTDIR}/C_Files/Informacion.o: C_Files/Informacion.c
	${MKDIR} -p ${OBJECTDIR}/C_Files
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/C_Files/Informacion.o C_Files/Informacion.c
...
${OBJECTDIR}/C_Files/Reservaciones.o: C_Files/Reservaciones.c
	${MKDIR} -p ${OBJECTDIR}/C_Files
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/C_Files/Reservaciones.o C_Files/Reservaciones.c

${OBJECTDIR}/C_Files/main.o: C_Files/main.c
	${MKDIR} -p ${OBJECTDIR}/C_Files
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/C_Files/main.o C_Files/main.c
